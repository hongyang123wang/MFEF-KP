...
from utils.utils import poly_iou_map
...
def get_map(MINOVERLAP, draw_plot, path = './map_out'):
        ...
        for line in lines_list:
            try:
                if "difficult" in line:
                    class_name, pt_x1, pt_y1, pt_x2, pt_y2, pt_x3, pt_y3, pt_x4, pt_y4, _difficult = line.split()
                    is_difficult = True
                else:
                    class_name, pt_x1, pt_y1, pt_x2, pt_y2, pt_x3, pt_y3, pt_x4, pt_y4 = line.split()
            except:
                if "difficult" in line:
                    line_split  = line.split()
                    _difficult  = line_split[-1]
                    pt_x1, pt_y1, pt_x2, pt_y2, pt_x3, pt_y3, pt_x4, pt_y4 = line_split[1:9]
                    class_name  = ""
                    for name in line_split[0]:
                        class_name += name + " "
            ...
            bbox = pt_x1 + " " + pt_y1 + " " + pt_x2 + " " + pt_y2 + " " + pt_x3 + " " + pt_y3 + " " + pt_x4 + " " + pt_y4
            if is_difficult:
    ...
    for class_index, class_name in enumerate(gt_classes):
        ...
        for txt_file in dr_files_list:
            ...
            for line in lines:
                try:
                    tmp_class_name, confidence, pt_x1, pt_y1, pt_x2, pt_y2, pt_x3, pt_y3, pt_x4, pt_y4 = line.split()
                except:
                    line_split      = line.split()
                    confidence      = line_split[1]
                    pt_x1, pt_y1, pt_x2, pt_y2, pt_x3, pt_y3, pt_x4, pt_y4 = line_split[2:10]
                    tmp_class_name  = ""
                    for name in line_split[0]:
                        tmp_class_name += name + " "
